...
#pragma endregion
 ...
 //   Microsoft::WRL::ComPtr<ID3D12Resource> materialResource = dxCommon->CreateBufferResource(sizeof(Material));
    ...
    sprite->GetTextureSrvHandleGPU()->ptr = dxCommon->GetSRVDescriptorHeap()->GetGPUDescriptorHandleForHeapStart().ptr;
	//戦闘はImGuiが使っているのでその次を使う
	textureSrvHandleCPU.ptr += dxCommon->GetDevice()->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
	sprite->GetTextureSrvHandleGPU()->ptr += dxCommon->GetDevice()->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
	//SRVの生成
    ...
    while (true)
    {
        ...
        else
        {
			...
			sprite->GetTransformationMatrixData()->world = worldMatrix;
			sprite->GetTransformationMatrixData()->WVP = worldViewProjectionMatrix;
			...
			sprite->GetMaterialData()->uvTransform = uvTransformMatrix;
			...
			//dxCommon->GetCommandList()->DrawIndexedInstanced(6, 1, 0, 0, 0);//06_00
